---
title: "Plotting Advanced Goalkeeping Stats With Plotly"
...
``` {r Shot Stopping 2020-21 to 2022-23, message = FALSE, warning = FALSE}
#Select keepers we want to add permanent annotations for in these plots
...
curData %>%
  plot_func(X=.$Stp_Pct, Y=.$Stp, textX = m$Stp_Pct, textY = m$Stp,
